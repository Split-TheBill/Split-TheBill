    ...
    return (
        <>
            <section className="relative top-[-400px]">
                <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative ">
                    <div className="flex justify-center items-center">
                        <img src={HeroImg} alt="" className="w-[350px]" />
                    </div>

                    <div className="flex flex-col justify-center py-14 md:py-0">
                        <div className="text-center md:text-left space-x-6 font-lexend ml-[80px]">
                            <h1 className="text-white text-4xl font-bold lg:text-5xl leading-relaxed xl:leading-normal relative bottom-[50px]">
                                Tentang Kami
                            </h1>
                            <p className="text-white xl:max-w-[500px] relative left-[-21px] font-light">
            ...
            <div className="relative h-[400px] bottom-[300px]">
                ...
                <div className="absolute bottom-[172px] w-full flex">
                    {clouds.map((cloud, index) => (
                        <img
                            key={`vertical-${index}`}
                            src={cloud}
